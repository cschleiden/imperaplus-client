import { IImmutable, makeImmutable } from "./node_modules/immuts";
...
const submitForm = (
    ...
    action: ActionPayload<FormActions.ISubmitPayload>
) => {
...
const changeField = (
    state: IImmutable<IForms>,
    action: ActionPayload<FormActions.IChangeFieldPayload>
) => {
...
const initialValue = (
    state: IImmutable<IForms>,
    action: ActionPayload<FormActions.IInitialValuePayload>
) => {
    const payload = action.payload;

...
export class AccountClient {
    ...
    protected processExchange(_response: Response): Promise<LoginResponseModel | null> {
     ...
     */
    getUserNameAvailable(userName: string): Promise<null | null> {
    ...
    protected processGetUserNameAvailable(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    protected processGetUserInfo(_response: Response): Promise<UserInfo | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGetExternalUserInfo(_response: Response): Promise<UserInfo | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: UserInfo | null = null;
    ...
    protected processLogout(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
    ...
    protected processGetManageInfo(_response: Response): Promise<ManageInfoViewModel | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processChangePassword(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processSetPassword(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processRemoveLogin(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processGetExternalLogins(_response: Response): Promise<ExternalLoginViewModel[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    register(model: RegisterBindingModel): Promise<null | null> {
    ...
    protected processRegister(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            return null;
            ...
            return throwException("A server error occurred.", _status, _responseText, result400);
            });
        } else if (_status !== 200 && _status !== 204) {
            return _response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", _status, _responseText);
    ...
    protected processResendConfirmationCode(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processConfirmEmail(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processForgotPassword(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processResetPassword(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processRegisterExternal(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
...
export class GameClient {
    ...
    protected processGetAll(_response: Response): Promise<GameSummary[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGetMy(_response: Response): Promise<GameSummary[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameSummary[] | null = null;
    ...
    protected processGetMyTurn(_response: Response): Promise<GameSummary[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameSummary[] | null = null;
    ...
    protected processPost(_response: Response): Promise<GameSummary | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameSummary | null = null;
    ...
    protected processGet(_response: Response): Promise<Game | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processDelete(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processGetMessages(_response: Response): Promise<GameChatMessage[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processPostJoin(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
...
is not the creator.
    ...
    protected processPostLeave(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
...
and game are still active.
    ...
    protected processPostSurrender(_response: Response): Promise<GameSummary | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameSummary | null = null;
    ...
    protected processPatchHide(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processPatchHideAll(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
...
export class HistoryClient {
    ...
    protected processGetTurn(_response: Response): Promise<HistoryTurn | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
...
export class LadderClient {
    ...
    protected processGetAll(_response: Response): Promise<LadderSummary[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGet(_response: Response): Promise<Ladder | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGetStandings(_response: Response): Promise<LadderStanding[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: LadderStanding[] | null = null;
            result200 = _responseText === "" ? null : <LadderStanding[]>JSON.parse(_responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (_status !== 200 && _status !== 204) {
            return _response.text().then((_responseText) => {
...
export class MapClient {
    ...
    protected processGetAllSummary(_response: Response): Promise<MapTemplateDescriptor[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGetMapTemplate(_response: Response): Promise<MapTemplate | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
...
export class MessageClient {
    ...
    protected processGetAll(_response: Response): Promise<Message[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGet(_response: Response): Promise<Message | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Message | null = null;
    ...
    protected processPatchMarkRead(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processPostSend(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
...
export class NewsClient {
    ...
    protected processGetAll(_response: Response): Promise<NewsItem[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
...
export class NotificationClient {
    ...
    protected processGetSummary(_response: Response): Promise<NotificationSummary | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
...
export class PlayClient {
    ...
    protected processPostPlace(_response: Response): Promise<GameActionResult | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processPostExchange(_response: Response): Promise<GameActionResult | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameActionResult | null = null;
    ...
    protected processPostAttack(_response: Response): Promise<GameActionResult | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameActionResult | null = null;
    ...
    protected processPostEndAttack(_response: Response): Promise<GameActionResult | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameActionResult | null = null;
...
possible anymore after moving.
    ...
    protected processPostMove(_response: Response): Promise<GameActionResult | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: GameActionResult | null = null;
    ...
    protected processPostEndTurn(_response: Response): Promise<Game | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Game | null = null;
...
export class TournamentClient {
    ...
    protected processGetById(_response: Response): Promise<Tournament | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Tournament | null = null;
    ...
    protected processPostJoin(_response: Response): Promise<TournamentTeam | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processGetTeams(_response: Response): Promise<TournamentTeam[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: TournamentTeam[] | null = null;
     ...
     */
    postCreateTeam(tournamentId: string, name: string, password: string): Promise<TournamentTeamSummary | null> {
        let url_ = this.baseUrl + "/api/tournaments/{tournamentId}/teams?";
        if (tournamentId === undefined || tournamentId === null)
            throw new Error("The parameter 'tournamentId' must be defined.");
        url_ = url_.replace("{tournamentId}", encodeURIComponent("" + tournamentId)); 
    ...
    protected processPostCreateTeam(_response: Response): Promise<TournamentTeamSummary | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: TournamentTeamSummary | null = null;
            result200 = _responseText === "" ? null : <TournamentTeamSummary>JSON.parse(_responseText, this.jsonParseReviver);
            return result200;
            });
        } else if (_status !== 200 && _status !== 204) {
            return _response.text().then((_responseText) => {
     ...
     */
    postJoinTeam(tournamentId: string, teamId: string, password: string): Promise<Blob | null> {
    ...
    protected processPostJoinTeam(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processDeleteTeam(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
    ...
    protected processLeaveTournament(_response: Response): Promise<Blob | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.blob();
        } else if (_status !== 200 && _status !== 204) {
...
export class UserClient {
    ...
    protected processFindUsers(_response: Response): Promise<UserReference[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {

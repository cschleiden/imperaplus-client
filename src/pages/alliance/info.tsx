...
import { deleteAlliance, get, leave, requestJoin, updateRequest } from "./alliances.actions";
...
export class AllianceInfoComponent extends React.Component<IAllianceInfoProps> {
    ...
    render(): JSX.Element {
        const { alliance, isAdmin, isMember, requests, canJoin, updateRequest, hasPendingRequest, userId } = this.props;

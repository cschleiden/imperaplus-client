...
const privacy = {
    "de": () => <div className="tos">
        <p className="disclaimer">
            Impera ist ein nicht-kommerzielles Hobby Projekt und ist komplett kostenlos.
        </p>

        <h4>Anbieter und verantwortliche Stelle im Sinne des Datenschutzgesetzes</h4>
        ...
        <p>Registrieren Sie sich auf unserer Webseite, um personalisierte Leistungen in Anspruch zu nehmen, werden personenbezogene Daten erhoben. Dazu zählen ein Pseudonym, sowie die E-Mail-Adresse als Kontakt- und Kommunikationsdaten.</p>
        ...
        <p>Werden Kommentare oder sonstige Beiträge auf unserem Angebot verfasst und veröffentlicht, speichern wir den Nutzernamen und den Zeitpunkt der Erstellung. Diese Daten werden aus Sicherheitsgründen erhoben, da der Anbieter für rechtswidrige Inhalte (verbotene Propaganda, Beleidigungen u.a.) belangt werden kann, auch wenn sie von dritter Seite erstellt wurden. In einem solchen Fall dienen die Informationen dazu, die Identität des Verfassers zu ermitteln.</p>
        ...
        <p>Quelle: Datenschutz-Konfigurator von <a href="https://www.mein-datenschutzbeauftragter.de">https://www.mein-datenschutzbeauftragter.de</a></p>

        <p>
            Diese Erkl&auml;rung wurde zuletzt am 9. September 2017 aktualisiert.
        </p>
    </div>,

    "en": () => <div className="tos">
        <p className="disclaimer">
        ...
        <p>We may collect personal identification information from Users in a variety of ways, including, but not limited to, when Users visit our site, register on the site, and in connection with other activities, services, features or resources we make available on our Site. Users may be asked for, as appropriate, user name and email address. We will collect personal identification information from Users only if they voluntarily submit such information to us. Users can always refuse to supply personally identification information, except that it may prevent them from engaging in certain Site related activities.</p>

...
import __, { getLanguage } from "../i18n/i18n";
    ...
    de: () => (
        <div className="tos">
            ...
            <ol>
                ...
                <li>
                    Wenn du dich 3 Monate lang nicht einloggst, wird dein
                    Account automatisch gel&ouml;scht.
                </li>
                <li>
                    Du musst mindestens 13 Jahre alt sein um Impera zu spielen.
                </li>
                <li>Jeder Spieler darf nur einen aktiven Account haben.</li>
                <li>
                    Accounts k&ouml;nnen jederzeit ohne Angeben von Gr&uuml;nden
                    gel&ouml;scht werden.
                </li>
                <li>Account Namen d&uuml;rfen nicht anst&ouml;ssig sein.</li>
                <li>
                    Nutzer sind selbst verantwortlich f&uum;r Nachrichten die
                    sie senden.
                </li>
            </ol>
            ...
            <ol>
                <li>
                    Impera ist lediglich eine Plattform, Nutzer sind selber
                    verantwortlich für Nachrichten die sie senden oder
            ...
            <p>
                ...
                oder zu ergänzen. Grundlegende Änderungen werden 30 Tage im
                voraus angekündigt.
            </p>

            <h4>Kontakt</h4>
            <p>
                Bei Fragen bitte kontaktiere{" "}
                <a href="mailto:info@imperaonline.de">uns</a>.
            </p>
        </div>
    ),
    ...
    en: () => (
        <div className="tos">
            ...
            <ol>
                ...
                <li>
                    If you haven't logged in for 3 months, your account will be
            ...
            <ol>
                <li>
                    Impera is only a platform, users are responsible for any
                    messages they send or content they post.
                </li>
            </ol>
    ...
    <Grid>
        <GridRow>
            <GridColumn className="col-xs-12">
                ...
                <i>
                    {__(
                        "Terms of service were last updated on September 9th 2017."
                    )}
                </i>
            </GridColumn>
        </GridRow>
...
Page.getTitle = () => __("Terms of Service");

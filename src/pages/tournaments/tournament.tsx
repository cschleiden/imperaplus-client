                    ...
                    <GridRow>
                        ...
                        <GridColumn className="col-md-6">
                            <dl className="dl-horizontal">
                                ...
                                <dd>
                                    {HumanTime(
                                        tournament.options.timeoutInSeconds
                                    )}
                                </dd>
                    ...
                    {isGroupTournament &&
                        tournament.state !== TournamentState.Open && (
                            <GridRow>
                                ...
                                <TournamentGroups
                                    tournament={tournament}
                                    navigateToPairing={this._navigateToPairing}
                                />
                            </GridRow>
                        )}
            ...
            registrationOpen && (
                <GridRow>
                    ...
                    {!isTeamTournament && !currentUserIsRegistered && (
                        <div>
                            <SimpleProgressButton onClick={this._join}>
                                {__("Join tournament")}
                            </SimpleProgressButton>
                        </div>
                    )}
                    ...
                    {!isTeamTournament && currentUserIsRegistered && (
                        <div>
                            <SimpleProgressButton onClick={this._leave}>
                                {__("Leave tournament")}
                            </SimpleProgressButton>
                        </div>
                    )}
                    ...
                    {isTeamTournament &&
                        ...
                        canLeaveTeam && (
                            <div>
                                ...
                                <SimpleProgressButton onClick={this._leaveTeam}>
                                    {__("Leave Team")}
                                </SimpleProgressButton>
                            </div>
                        )}
...
export default connect(
    (state: IState, ownProps: ITournamentProps) => {
    ...
    dispatch => ({
        ...
        join: (tournamentId: string) => {
            dispatch(join(tournamentId));
        },
        leave: (tournamentId: string) => {
            dispatch(leave(tournamentId));
        },
        joinTeam: (
            tournamentId: string,
            teamId: string,

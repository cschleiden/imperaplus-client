...
class GameDetails extends React.Component<
    IGameDetailsProps & IGameDetailsDispatchProps
> {
    public render() {
        ...
        return (
            <GridRow>
                <GridColumn className="col-md-6">
                    <h2 className="game-details-name">
                    ...
                    <dl className="game-details">
                        ...
                        <dd>
                            {HumanDate(
                                this.props.game.startedAt ||
                                    this.props.game.lastActionAt
                            )}
                        </dd>
                        ...
                        <dd>
                            {this.props.game.options.attacksPerTurn} /{" "}
                            {this.props.game.options.movesPerTurn}
                        </dd>

                        <dt>{__("Victory Conditions")}</dt>
                        <dd>{this.props.game.options.victoryConditions}</dd>

                        <dt>{__("Max bonus cards")}</dt>
                        <dd>{this.props.game.options.maximumNumberOfCards}</dd>

                        <dt>{__("Visibility Modifier")}</dt>
                        <dd>{this.props.game.options.visibilityModifier}</dd>
                ...
                <GridColumn className="col-md-6">
                    <MapPreview
                        mapTemplateName={this.props.game.mapTemplate}
                        responsive
                    />
                </GridColumn>
            </GridRow>
    ...
    private _renderPlayer(): JSX.Element[] {
        const sortedTeams = this.props.game.teams
            .slice(0)
    ...
    private _player(): PlayerSummary | null {
        for (let team of this.props.game.teams) {
            for (let player of team.players) {
                if (
                    player.userId === store.getState().session.userInfo.userId
                ) {
                    return player;
                }
            }
